...
//determine if a character us a vowel
...
Examples:
    ...
    {first: 'Matt', last:"Lane"}, {first: 'Colt', last:"Steele", isCatOwner: true}], 'isCatOwner') // [{first: 'Tim', last:"Garcia", isCatOwner: true}, {first: 'Colt', last:"Steele", isCatOwner: true}]
*/
...
function removeVowels(str) {
    ...
    let strArr = [...loweredStr];
    let filteredArr = strArr.filter(function (char) {
...
function doubleOddNumbers(arr) {
    ...
    let doubledOdds = odds.map(function (num) {
        return num * 2;
    })
    return doubledOdds;
}
